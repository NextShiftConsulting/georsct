% =====================================================================
% results_spatial_diagnostics.tex
% Spatial-validity subsection scaffold for the SIGSPATIAL paper.
% \input{} this fragment. Requires: booktabs, graphicx (acmart provides both).
%
% PLACEHOLDER CONVENTION
%   Every [X] / [N.NN] is a bracketed placeholder to fill at data lock.
%   Each is annotated with the JSON/parquet field it maps to in a % comment.
%   grep '\[' this file to find every value still to populate.
%
