...
CODE_PREFIX = "rsct_code/series_019/s019d"
OUTPUT_PREFIX = "rsct_curriculum/series_019/results/s019d_bootstrap"
SEEDS = [42, 123, 456]
...
def bootstrap_results_group() -> ArtifactGroup:
    ...
    for seed in SEEDS:
        artifacts.append(
            S3Artifact(BUCKET,
                       f"rsct_curriculum/series_019/results/s019d/seed_{seed}/s019d_results.json",
