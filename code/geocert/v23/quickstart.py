#!/usr/bin/env python3
"""
quickstart.py -- Download GeoCert and verify you have good data.
...
def main():
    parser = argparse.ArgumentParser(description="GeoCert quickstart: verify and summarize")
    parser.add_argument("--data-dir", type=str, default=".",
                        help="Directory containing geocert parquet files")
    args = parser.parse_args()

    data = Path(args.data_dir)
    table_path = data / "geocert_table.parquet"
    checksum_path = data / "geocert_checksums.sha256"
    errors = []
    ...
    expected_files = [
        "geocert_table.parquet",
        "geocert_simplified_001.geoparquet",
        "geocert_schema.json",
        "build_manifest.json",
        "geocert_checksums.sha256",
        "load_geocert.py",
    ]
