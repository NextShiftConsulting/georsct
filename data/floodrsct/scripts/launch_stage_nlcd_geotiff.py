...
def main() -> None:
    ...
    launch_processing_job(
        ...
        volume_size_gb=100,
        pre_install_cmd="conda create -y -n geo -c conda-forge python=3.11 rasterio boto3 requests && export PATH=/opt/conda/envs/geo/bin:$PATH && export LD_LIBRARY_PATH=/opt/conda/envs/geo/lib:$LD_LIBRARY_PATH",
