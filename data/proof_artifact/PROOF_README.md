...
with TRF across the 27 CONUS-27 tasks.
...
- "Ceiling-conditioned architecture sensitivity" is false — no continuous interaction
  between TRF and architecture spread exists in the data.
...
| File | Contents |
|------|----------|
| `s019d_interaction_proof_table.csv` | 27-task vectors (arch_spread, task_residual_floor) for seeds 42/123/456 |
...
- TRF: mean of task_residual_floor field across folds per task
...
- Local and S3 verified identical (27/27 tasks, all TRF values match to 4 decimal places)
